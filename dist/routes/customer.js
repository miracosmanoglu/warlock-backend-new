...
router.post("/register", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, username, name, surname, phone, emailExist, usernameExist, phoneExist, _b, customer, e_1, e_2;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.body, email = _a.email, username = _a.username, name = _a.name, surname = _a.surname, phone = _a.phone;
                _c.label = 1;
            case 1:
            ...
            case 7:
                customer = _c.sent();
                res.send(JSON.stringify({ status: 200, error: null, response: customer.id }));
                return [3 /*break*/, 9];
            case 8:
                e_1 = _c.sent();
                res.send(JSON.stringify({
                    status: 500,
                    error: "In create customer " + e_1,
                    response: null
                }));
                return [3 /*break*/, 9];
            ...
            case 10:
                e_2 = _c.sent();
                res.send(JSON.stringify({ status: 500, error: "In customer " + e_2, response: null }));
                return [3 /*break*/, 11];
...
router.post("/login", function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var email, customer, valid, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, bcrypt_1["default"].compare(req.body.password, customer[0].password)];
                case 2:
                    valid = _a.sent();
                    if (!valid) {
