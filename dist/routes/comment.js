...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, text, rate, gigId, customerId, user, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, text = _a.text, rate = _a.rate, gigId = _a.gigId, customerId = _a.customerId;
